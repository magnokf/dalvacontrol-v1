...
class Web extends Controller
{
    ...
    public function blog(?array $data): void
    {
        $head = $this->seo->render(
            "Blog - " . CONF_SITE_NAME,
            "Confira em nosso blog dicas e sacadas de como controlar.",
            url("/blog"),
            theme("/assets/images/share.jpg")
        );
    ...
    public function register(?array $data): void
    {
        ...
        if (!empty($data['csrf'])) {
            ...
            /**if (in_array("", $data)) {
                $json['message'] = $this->message->info("Informe seus dados para serem atualizados.")->render();
                echo json_encode($json);
                return;
            }**/
            ...
            $responsa = new Responsa();




            if ($auth->register($user, $responsa)) {
    ...
    public function confirm(): void
    {
        ...
        echo $this->view->render("optin", [
            "head" => $head,
            "data" => (object)[
                "title" => "Obrigada por sua colaboração.",
                "desc" => "As atualizações de suas informações de contato do aluno são muitos importantes para Escola.",
    ...
    public function success(array $data): void
    {
        ...
        echo $this->view->render("optin", [
            ...
            "data" => (object)[
                ...
                "desc" => "Bem-vindo(a) ao DalvaControle.",
    ...
    public function error(array $data): void
    {
        ...
        switch ($data['errcode']) {
            ...
            default:
                ...
                $error->message = "Sentimos muito, mas o conteúdo que você tentou acessar não existe, não está disponível no momento ou foi removido :/";
