...
<div class="container" style="margin-top: 30px">
    ...
    <div style="text-align: center;"><h4 style="color: #0b0b0b">E M Dalva de Oliveira</h4><br>
        <h3><span class="label label-danger">Lista Mocidade </span></h3></div>
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-hover">
                ...
                $sql = $conn->query('SELECT * FROM responsa A left join mocidade_cestas B on A.pes_nome = B.pes_aluno where B.pes_aluno IS NULL ;');
                while($data = $sql->fetch_array()) {
                    echo '
                                    <tr>
                                        ...
                                        <td><a href="tel:'.$data['telefone1'].'">'.$data['telefone1'].'</a></td>
