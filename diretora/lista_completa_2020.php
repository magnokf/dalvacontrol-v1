...
<div class="container" style="margin-top: 30px">
    ...
    <div style="text-align: center;"><h4 style="color: #0b0b0b">E M Dalva de Oliveira</h4><br>
        <h3><span class="label label-danger">Lista Geral Matricula Alunos 2020 </span></h3></div>
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-hover">
                ...
                $sql = $conn->query('SELECT * FROM 1docescrelacaoresponsaveis ');
                while($data = $sql->fetch_array()) {
                    echo '
                                    <tr>
                                        
                                        
                                        <td>'.utf8_encode($data['pes_nomeAluno2']).'</td>
                                        <td>'.utf8_encode($data['pes_nomeResponsavel3']).'</td>
                                        <td>'.utf8_encode($data['tur_id2']).'</td>
