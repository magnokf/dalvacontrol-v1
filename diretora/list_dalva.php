...
<div class="container" style="margin-top: 30px">
    ...
    <div style="text-align: center;"><h4 style="color: #0b0b0b">E M Dalva de Oliveira</h4><br>
        <h3><span class="label label-danger">Lista Geral de Alunos Atualizados no Sistema </span></h3></div>
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-hover">
                ...
                $sql = $conn->query('SELECT * FROM users group by pes_nome');
                while($data = $sql->fetch_array()) {
                    echo '
                                    <tr>
                                        ...
                                        <td><a href="tel:'.$data['telefone1'].'">'.$data['telefone1'].'</a><br> <br> <a href="tel:'.$data['telefone2'].'">'.$data['telefone2'].'</a></td>
                                        
                                        <td><a href="mailto:'.$data['email'].'?Subject=Contato%20DalvaControl%20-%20Escola%20Municipal%20Dalva%20de%20Oliveira" target="_top">'.$data['email'].'</a></td>
